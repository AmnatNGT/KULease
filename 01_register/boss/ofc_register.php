            ...
            <div class="form">
                ...
                <div class="inputfield">
                    ...
                    <div class="custom_select">
                        <!-- เมื่อเลือกคำนำหน้าชื่อแล้วให้ส่ง value ที่เลือกไปที่ function type_name Row: 71 -->
                ...
                <script>
                    function type_name() {
                        ...
                        // ถ้าคำนำหน้าชื่อเป็น n4 (อื่นๆ) ให้แสดงช่องกรอกข้อมูล tn_p_name_oth ที่อยู่บรรทัด 60
                        if (index == 'n4') {
                            document.getElementById('tn_p_name_oth').style.display = '';
                        }
                        // ถ้าคำนำหน้าชื่อไม่เป็น n4 (อื่นๆ) ให้ไม่ต้องแสดงช่องกรอกข้อมูล tn_p_name_oth ที่อยู่บรรทัด 87 ให้เป็น style="display:none" เหมือนเดิม
                        else {
                ...
                <?php
                //เป็นการนำปีปัจจุบัน -18 เพื่อนำไปใช้ที่บรรทัด 117 คือเป็นการ fix ว่าผู้ใช้งานต้องอายุมากกว่า 18
                ...
                <div class="inputfield">
                    ...
                    <!-- ให้มีเริ่มต้นที่แสดงในปฏิทิน เป็นปีที่ ปีปัจจุบัน - 18 คือค่า $date_fix ที่ได้รับจากบรรทัด 109 -->
