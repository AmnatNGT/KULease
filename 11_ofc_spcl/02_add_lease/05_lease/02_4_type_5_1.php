<?php {
    ...
    //หาข้อมูลพื้นที่
    $sql_area = "SELECT * FROM area WHERE area_type = '5' AND area_status_show = 1 AND area_status = '0' ";
...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper_3">
            ...
            <!-- เพิ่มข้อมูลและส่งไปหน้า 02_4_type_5_2_db.php แบบ POST -->
            <form action="02_4_type_5_2_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form">
                    ...
                    <div class="inputfield">
                        <label>ราคาเช่าคิดเป็นร้อยละ / ของยอดขายแต่ละเดือน (%) <strong>*</strong></label>
                        <input type="number" class="input" name="mn_100" id="mn_100" required>
                    </div>
    ...
    <!--script-->
    <script>
        // ถ้าข้องมูลของพื้นที่ เกิดการเปลี่ยนแปลงจากบรรทัด 185 ให้ส่งค่า id พื้นที่มาที่นี่
        $('#area_name').change(function() {
            ...
            //เมื่อเสร็จแล้วส่งขนาดพื้นที่ ที่ตรงกับพื้นที่ที่เลือก กลับมาที่ตัวแปร data และแสดงผลที่ area_size บรรทัด 195
            $.ajax({
                type: "POST",
