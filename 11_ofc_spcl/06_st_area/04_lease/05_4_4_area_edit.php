...
<body>
    ...
    <main class="data ">
        <div class="wrapper_e">
            ...
            <!-- Back -->
            <div>
                <a href="05_4_1_area.php" class="back" style="text-decoration:none;">
            ...
            <div class="wrapper_md_ar">
                ...
                <div class="title">
                    แก้ไขพื้นที่เช่า ประเภทสัญญาเพื่อที่พักอาศัย
                </div>
                <div class="form">
                    ...
                    <div class="inputfield">
                        ...
                        <!-- ถ้ากดแก้ไข ให้ไปหา modal  #showForm1 เพื่อแก้ไข -->
                    ...
                    <div class="inputfield">
                        ...
                        <!-- ถ้ากดแก้ไข ให้ไปหา modal  #showForm2 เพื่อแก้ไข -->
                        <a class="btn btn-warning" data-bs-target="#showForm2" data-bs-toggle="modal">แก้ไข</a>
                    </div>

                    <div class="inputfield">
                        <label>เลขที่ห้องพัก <strong style="color:red;">*</strong></label>
                        <input type="text" class="input" value="<?php echo $row['area_room_no']; ?>" readonly>
                        <!-- ถ้ากดแก้ไข ให้ไปหา modal  #showForm3 เพื่อแก้ไข -->
                    ...
                    <div class="inputfield">
                        ...
                        <!-- ถ้ากดแก้ไข ให้ไปหา modal  #showForm4 เพื่อแก้ไข -->
         ...
         <!--แก้ไขเลขที่พื้นที่-->
        <!-- #showForm1 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_4_5_area_edit_db.php-->
        <form action="05_4_5_area_edit_db.php" method="POST">
        ...
        <!--แก้ไขบริเวณที่เช่า-->
        <!-- #showForm2 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_4_5_area_edit_db.php-->
        <form action="05_4_5_area_edit_db.php" method="POST">
        ...
        <!--แก้ไขเลขที่ห้องพัก-->
        <!-- #showForm3 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_4_5_area_edit_db.php-->
        <form action="05_4_5_area_edit_db.php" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="wrapper_md">
                                ...
                                <div class="form">
                                    ...
                                    <div class="inputfield">
                                        <label>เลขที่ห้องพัก <strong style="color:red;">*</strong></label>
                                        <input type="text" class="input" placeholder="เลขที่ห้องพัก" name="area_room_no" required>
                                    </div>
        ...
        <!--แก้ไขขนาดที่เช่า-->
        <!-- #showForm4 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_4_5_area_edit_db.php-->
        <form action="05_4_5_area_edit_db.php" method="POST">
