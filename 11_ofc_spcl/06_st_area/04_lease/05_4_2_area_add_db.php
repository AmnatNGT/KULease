...
if (isset($_POST['save_area'])) {
    ...
    $area_room_no = $_POST['area_room_no'];
    ...
    $query_area = "INSERT INTO area (ofc_id, area_type, area_no, area_name, area_room_no, 
                                    area_size, area_status, area_status_show, area_date_add, area_time_add)
                                VALUE('$ad_id', '$area_type', '$area_no', '$area_name', '$area_room_no', 
                                            '$area_size', '$area_status', '$area_status_show' , '$area_date_add', '$area_time_add')";
    ...
    if ($result_area) {
        ...
        // ถ้าเสร็จแล้วไปหน้า 05_4_1_area.php
        echo "window.location='05_4_1_area.php';";
        echo "</script>";
    } else {
        echo "<script type='text/javascript'>";
