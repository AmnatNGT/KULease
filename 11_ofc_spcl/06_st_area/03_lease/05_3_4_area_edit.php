...
<body>
    ...
    <main class="data ">
        <div class="wrapper_e">
            ...
            <!-- Back -->
            <div>
                <a href="05_3_1_area.php" class="back" style="text-decoration:none;">
            ...
            <div class="wrapper_md_ar">
                ...
                <div class="title">
                    แก้ไขพื้นที่เช่า ประเภทสัญญาเพื่องานวิจัย / การเรียนการสอน
                </div>
                <div class="form">
         ...
         <!--แก้ไขเลขที่พื้นที่-->
        <!-- #showForm1 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_3_5_area_edit_db.php-->
        <form action="05_3_5_area_edit_db.php" method="POST">
        ...
        <!--แก้ไขบริเวณที่เช่า-->
        <!-- #showForm2 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_3_5_area_edit_db.php-->
        <form action="05_3_5_area_edit_db.php" method="POST">
         ...
         <!--แก้ไขขนาดที่เช่า-->
        <!-- #showForm3 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_3_5_area_edit_db.php-->
        <form action="05_3_5_area_edit_db.php" method="POST">
