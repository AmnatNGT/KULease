<?php {
    ...
    //ดึงข้อมูลพื้นที่
    $sql = "SELECT * FROM area WHERE area_id = $area_id "; //ดึงข้อมูลทั้งหมดออกมาก และเรียงตามพยัญชนะชื่อ
    $result = mysqli_query($conn, $sql); //ข้อมูลที่ดึงมาไว้ในตัวแปร result
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_e">
            ...
            <!-- Back -->
            <div>
                <a href="05_2_1_area.php" class="back" style="text-decoration:none;">
            ...
            <div class="wrapper_md_ar">
                ...
                <div class="title">
                    แก้ไขพื้นที่เช่า ประเภทสัญญาเพื่องานบริการ
                </div>
                <div class="form">
                    ...
                    <div class="inputfield">
                        ...
                        <input type="text" class="input" value="<?php echo $row['area_width']; ?>" readonly>
                        <!-- ถ้ากดแก้ไข ให้ไปหา modal  #showForm4 เพื่อแก้ไข ขนาดความกว้าง-->
                        <a class="btn btn-warning" data-bs-target="#showForm4" data-bs-toggle="modal">แก้ไข</a>
                    </div>

                    <div class="inputfield">
                        <label>ขนาดความยาว (เมตร) <strong style="color:red;">*</strong></label>
                        <input type="text" class="input" value="<?php echo $row['area_height']; ?>" readonly>
                        <!-- ถ้ากดแก้ไข ให้ไปหา modal  #showForm5 เพื่อแก้ไข ขนาดความยาว-->
                        <a class="btn btn-warning" data-bs-target="#showForm5" data-bs-toggle="modal">แก้ไข</a>
                    </div>
        ...
        <!-- เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_2_5_area_edit_db.php-->
        <form action="05_2_5_area_edit_db.php" method="POST">
        ...
        <!--แก้ไขบริเวณที่เช่า-->
        <!-- #showForm2 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_2_5_area_edit_db.php-->
        <form action="05_2_5_area_edit_db.php" method="POST">
        ...
        <!--แก้ไขขนาดที่เช่า-->
        <!-- #showForm3 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_2_5_area_edit_db.php-->
        <form action="05_2_5_area_edit_db.php" method="POST">
        ...
        <!--แก้ไขความกว้างที่เช่า-->
        <!-- #showForm4 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_2_5_area_edit_db.php-->
        <form action="05_2_5_area_edit_db.php" method="POST">
            ...
            <div class="modal fade" id="showForm4">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="" class="btn_no_s" data-bs-dismiss="modal">ยกเลิก</a>
                            <button class="btn_yes" name="e4">บันทึกข้อมูล</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--แก้ไขความยาวที่เช่า-->
        <!-- #showForm5 เมื่อกดบันทึก ส่งข้อมูลไปที่หน้า  05_2_5_area_edit_db.php-->
        <form action="05_2_5_area_edit_db.php" method="POST">
            ...
            <div class="modal fade" id="showForm5">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="" class="btn_no_s" data-bs-dismiss="modal">ยกเลิก</a>
                            <button class="btn_yes" name="e5">บันทึกข้อมูล</button>
                        </div>
                    </div>
                </div>
            </div>
