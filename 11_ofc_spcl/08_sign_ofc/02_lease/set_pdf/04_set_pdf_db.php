...
$html = "<p style='color:red; position:absolute; top:834; left:485;'><img src='../../../../file_uploads/doc_signs/$pic'  width='190' height='45'></p>";
...
//แจ้งเตือนนิติกร
{
    ...
    $tn_tel = $row2['ofc_tel'];
    $detail = "สัญญาเพื่องานบริการ เลขที่สัญญาเช่า : $leno เจ้าหน้าที่ลงนามเสร็จแล้ว ต่อไปอยู่ในสถานะนิติกรลงนาม โปรดตรวจสอบ";
