...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper_2">
            ...
            <div class="title">
                เจ้าหน้าที่ ลงนามสัญญาเช่า <br> เลขที่สัญญาเช่า : <?php echo $row_le['le_no']; ?>
            </div>
            ...
            <div class="form">
                ...
                <input type="hidden" name="fullname" id="fullname" value="<?php echo $row_le['le_no']; ?>_ofc_spcl_sign.png">
                            ...
                            onrendered: function(canvas) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        alert("กรุณาตรวจสอบที่ SMS โทรศัพท์ หรือ Email เพื่อยืนยัน OTP");
                ...
                <table id="customers">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo date('d / m / Y ', strtotime($row_le["otp_date_tn2"])); ?></td>
                            <td><?php echo $row_le['otp_time_tn2'] ?></td>
