<?php {
    ...
    $sql_le = "SELECT * FROM lease WHERE le_no = $le_no AND le_type = 5 ";
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <!-- Back -->
            <div>
                <a href="05_1_money.php" class="back" style="text-decoration:none;">
                        ...
                        <tbody>
                            ...
                            <?php if ($row_1['mn_status'] != 100) { ?>
                                <tr>
                                    ...
                                    <td><a href="05_5_see_data_05_2_3.php?le_id=<?php echo $row_1["le_id"]; ?>"> <?php echo  $row_1['le_no']; ?> </a></td>
