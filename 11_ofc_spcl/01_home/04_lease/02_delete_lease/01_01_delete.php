            ...
            <div class="form">
                ...
                <?php if ($row_le['ad_id'] != null) { ?>
                    <div class="inputfield">
                        ...
                        <input type="text" class="input" value="<?php echo $row_ad['ad_p_name'] . " " . $row_ad['ad_f_name'] . " " . $row_ad['ad_l_name']; ?>" disabled>
                    </div>
                <?php } ?>
                ...
                <?php if ($row_le['ofc_id'] != null) { ?>
                    <div class="inputfield">
                        <label>เจ้าหน้าที่ผู้เพิ่มสัญญาเช่า</label>
                        <input type="text" class="input" value="<?php echo $row_ofc['ofc_p_name'] . " " . $row_ofc['ofc_f_name'] . " " . $row_ofc['ofc_l_name']; ?>" disabled>
                    </div>
                <?php } ?>

                <div class="inputfield">
                    <label>ว/ด/ป เพิ่มสัญญาเช่า</label>
                    <input type="date" class="input" value="<?php echo $row_le['d_ad_le'] ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>เวลา เพิ่มสัญญาเช่า</label>
                    <input type="time" class="input" value="<?php echo $row_le['t_ad_le'] ?>" disabled>
                </div>
                ...
                <div class="inputfield">
                    ...
                    <?php if ($row_le['le_no_success'] == null) { ?>
                        <a class="input" style="color:red">ไม่มีเอกสารสัญญาเช่า</a>
                    <?php } else { ?>
                        <a href="../../../../file_uploads/lease_success/<?php echo $row_le['le_no'] . '.pdf' ?>" style="color:blue" target="_blank" class="input">ดูเอกสารสัญญาเช่า</a>
                    <?php } ?>
                </div>

                <div class="inputfield">
                    <label>ประเภทสัญญาเช่า</label>
                    <input type="text" class="input" value="เพื่อที่พักอาศัย" disabled>
                </div>
                ...
                <div class="inputfield">
                    ...
                    ?>
                    <input type="text" class="input" value="<?php echo $no_success; ?>" disabled>
                </div>

                <!-- ตรวจสอบข้อมูลผู้ให้เช่า -->
                <div class="inputfield">
                    <label>ชื่อ - นามสกุล ผู้ให้เช่า</label>
                    <input type="text" class="input" value="<?php echo $row_ls['ls_p_name'] . " " . $row_ls['ls_f_name'] . " " . $row_ls['ls_l_name']; ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ตำแหน่ง ผู้ให้เช่า</label>
                    <input type="text" class="input" value="<?php echo $row_ls['ls_role']; ?>" disabled>
                </div>

                <!-- ผู้เช่า -->
                <div class="inputfield">
                    <label>ชื่อ - นามสกุล ผู้เช่า</label>
                    <input type="text" class="input" value="<?php echo $row_tn["tn_p_name"] . " " . $row_tn["tn_f_name"] . " " . $row_tn["tn_l_name"]; ?>" disabled>
                </div>
                ...
                <div class="inputfield">
                    ...
                    ?>
                    <input type="text" class="input" value="<?php echo $tn_role; ?>" disabled>
                </div>
                ...
                <div class="inputfield">
                    ...
                    <input type="text" class="input" value="<?php echo $row_area["area_name"] ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ห้องพักเลขที่</label>
                    <input type="text" class="input" value="<?php echo $row_area["area_room_no"] ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ขนาดพื้นที่เช่า (ตร.ม.)</label>
                    <input type="text" class="input" value="<?php echo $row_area["area_size"] ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>วัตถุประสงค์การเช่า</label>
                    <input type="text" class="input" value="<?php echo $row_le["le_purpose"] ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ระยะเวลาการเช่า (ปี)</label>
                    <input type="text" class="input" value="<?php echo $row_le["le_duration"] . " ปี"; ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ว/ด/ป เริ่มสัญญา</label>
                    <input type="date" class="input" value="<?php echo $row_le["le_start_date"] ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ว/ด/ป สิ้นสุดสัญญา</label>
                    <input type="date" class="input" value="<?php echo $row_le["le_end_date"] ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ราคาเช่า / เดือน (บาท)</label>
                    <input type="text" class="input" value="<?php echo $row_mn_month["mn_cost"] . " บาท" ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>ราคาเช่า / ปี (บาท)</label>
                    <input type="text" class="input" value="<?php echo ($row_mn_month["mn_cost"] * 12) . " บาท" ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>เจ้าหน้าที่ผู้ลงนาม</label>
                    <input type="text" class="input" value="<?php echo $row_wn_1["ofc_p_name"] . " " . $row_wn_1["ofc_f_name"] . " " . $row_wn_1["ofc_l_name"] ?>" disabled>
                </div>
                ...
                <div class="inputfield">
                    ...
                    ?>
                    <input type="text" class="input" value="<?php echo $result_role_1 ?>" disabled>
                </div>

                <div class="inputfield">
                    <label>นิติกรผู้ลงนาม</label>
                    <input type="text" class="input" value="<?php echo $row_wn_2["ofc_p_name"] . " " . $row_wn_2["ofc_f_name"] . " " . $row_wn_2["ofc_l_name"] ?>" disabled>
                </div>
                ...
                <div class="inputfield">
                    ...
                    ?>
                    <input type="text" class="input" value="<?php echo $result_role_2 ?>" disabled>
                </div>
