...
$html .= "<p style='color:red; position:absolute; top:833; left:142;'><img src='../../../../file_uploads/doc_signs/$pic2'  width='190' height='45' ></p>";
...
//แจ้งเตือนเจ้าหน้าที่พิเศษ หรือพี่เล็ก ลงนาม
{
    ...
    $tn_tel = $row2['ofc_tel'];
    $detail = "สัญญาเพื่องานบริการ/การเรียนการสอน เลขที่สัญญาเช่า : $leno ผู้เช่าลงนามเสร็จแล้ว ต่อไปอยู่ในสถานะเจ้าหน้าที่ลงนาม โปรดตรวจสอบ";
