...
// เมื่อผู้ให้เช่ากดแก้ไข password จากอีเมล แล้วจะมาหน้านี้
...
if (isset($_POST['submit'])) {
    ...
    //ถ้า tic captcha แล้ว
        ...
        //  ถ้าตรงกัน
            ...
            //update password ใหม่ที่ id ผู้ให้เช่านั้นๆ
            $sql = "UPDATE lessor SET ls_password = '$pw' WHERE ls_id = '$ad_id' ";
