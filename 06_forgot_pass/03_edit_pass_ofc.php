...
// เมื่อเจ้าหน้าที่แก้ไข password จากอีเมล แล้วจะมาหน้านี้
...
if (isset($_POST['submit'])) {
    ...
    //ถ้า tic captcha แล้ว
        ...
        //  ถ้าตรงกัน
            ...
            //update password ใหม่ที่ id เจ้าหน้าที่นั้นๆ
            $sql = "UPDATE officer SET ofc_password = '$pw' WHERE ofc_id = '$ofc_id' ";
