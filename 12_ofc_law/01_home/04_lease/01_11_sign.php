...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ตรวจสอบการลงนาม ประเภทสัญญาเพื่อที่พักอาศัย
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                                ...
                                <td style="color: green;">ผู้จัดการหอพักลงนาม<br> และยืนยันตัวตน  <br> ผ่าน OTP สำเร็จ</td>
                            <?php } else { ?>
                                <td>----------</td>
                                <td>----------</td>
                                <td style="color: red;">ผู้จัดการหอพักยังไม่ได้ลงนาม</td>
                            <?php } ?>
