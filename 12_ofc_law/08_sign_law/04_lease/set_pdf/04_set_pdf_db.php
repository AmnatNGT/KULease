...
$html = "<p style='color:red; position:absolute; top:902; left:468;'><img src='../../../../file_uploads/doc_signs/$pic'  width='190' height='45'></p>";
...
//แจ้งเตือนผู้ให้เช่า
{
    ...
    $tn_tel = $row2['ls_tel'];
    $detail = "สัญญาเพื่อที่พักอาศัย เลขที่สัญญาเช่า : $leno เจ้าหน้าที่ลงนามเสร็จแล้ว ต่อไปอยู่ในสถานะนิติกรลงนาม โปรดตรวจสอบ";
