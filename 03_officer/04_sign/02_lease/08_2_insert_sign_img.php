    ...
    <main class="data ">
        ...
        <div class="wrapper_2">
            ...
            <div class="form">
                ...
                <!-- เมื่อกดส่งไปหน้า  08_3_insert_img_db.php-->
                <form action="08_3_insert_img_db.php" method="POST" enctype="multipart/form-data">
                    <!-- ชื่อรูปลายเซน -->
                    <input type="hidden" name="name" value="<?php echo $row_le['le_no']; ?>_tn_sign">
