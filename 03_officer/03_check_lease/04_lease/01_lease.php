<?php {
    ...
    //หาข้อมูลสัญญา
    //ที่ ประเภทสัญญ=4 และ สถานะสัญญา=0 
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            <div class="title">
                ตรวจสอบสัญญาเช่า ประเภทสัญญาเพื่อที่พักอาศัย
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                ...
                                <?php } else { ?>
                                    <td><a href="../see_pdf/04_success.php?le_id=<?php echo $row['le_id']; ?>" class="btn btn-primary">ตรวจสอบเอกสาร</a></td>
                                <?php } ?>
