...
<?php
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ประเภทสัญญาเช่าเพื่อที่พักอาศัย ที่หมดอายุสัญญาเช่าภายใน 30 วัน
            </div>
                ...
                <div class="form">
                    ...
                    <table id="customers">
                        ...
                        <tbody>
                            ...
                            ?>
                                 <!-- หาสัญญาเช่าประเภทที่ 4 ที่หมดอายุภายใน 30 วัน และแสดง -->
                                 <?php if ($diff->format("%R%a") <= 30 and $diff->format("%R%a") >= 0) { ?>
