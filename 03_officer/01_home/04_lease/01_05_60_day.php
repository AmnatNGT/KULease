<?php {
    ...
    //ประเภท 4
    $sql = "SELECT * FROM lease WHERE le_type=4 AND le_status=1";
...
<?php
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ประเภทสัญญาเช่าเพื่อที่พักอาศัย ที่หมดอายุสัญญาเช่าภายใน 60 วัน
            </div>
                ...
                <div class="form">
                    ...
                    <table id="customers">
                        ...
                        <tbody>
                            <!-- สัญญาเพื่อร้านค้าหรือพาณิชย์ 4-->
                            <?php while ($row = mysqli_fetch_assoc($result)) {
                                $ch_end_1_120 = date_create($row['le_end_date']);
                                $diff = date_diff($today, $ch_end_1_120);
                            ?>
                                <!-- หาสัญญาเช่าประเภทที่ 4 ที่หมดอายุภายใน 60 วัน และแสดง -->
                                <?php if ($diff->format("%R%a") <= 60 and $diff->format("%R%a") > 30) { ?>
