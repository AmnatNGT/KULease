<?php {
    ...
    //สัญญาเช่า ประเภท 3
    $sql = "SELECT * FROM lease WHERE le_type=3 AND le_status=1";
...
<?php
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ประเภทสัญญาเช่าเพื่องานวิจัย / การเรียนการสอน ที่หมดอายุสัญญาเช่าภายใน 60 วัน
            </div>
                ...
                <div class="form">
                    ...
                    <table id="customers">
                        ...
                        <tbody>
                            ...
                            ?>
                                <!-- หาสัญญาเช่าประเภทที่ 3 ที่หมดอายุภายใน 60 วัน และแสดง -->
