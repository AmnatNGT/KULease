<?php {
    ...
    // ประเภทสัญญา 1 และ mn_type =3 (เงินรายเดือน/ปี)
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="form">
                ...
                <!-- ค้นหาด้วยเลขที่อ้างอิงสัญญา ส่งไปหน้า 01_3_search_money_see.php-->
                <form action="01_3_search_money_see.php" method="POST">
                ...
                <table id="customers">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                ...
                                <td><a href="01_4_see_data_01_1.php?le_id=<?php echo $row["le_id"]; ?>"> <?php echo  $row['le_no']; ?> </a></td>
                                ...
                                <!-- ดูสถานะการเงิน ส่ง id สัญญา ไปหน้า 01_2_money_see.php-->
                    ...
                    <?php while ($row2 = mysqli_fetch_assoc($result2)) { ?>
                        <tr>
                            ...
                            <td><a href="01_4_see_data_01_1.php?le_id=<?php echo $row2["le_id"]; ?>"> <?php echo  $row2['le_no']; ?> </a></td>
                            ...
                            <td><a href="01_2_money_see.php?le_id=<?php echo $row2['le_id'] ?>" class="btn_pri">ดูสถานะการเงิน</a></td>
