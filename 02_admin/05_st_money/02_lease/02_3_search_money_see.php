<?php {
    ...
    $sql_le = "SELECT * FROM lease WHERE le_no = $le_no AND le_type = 2 ";
    ...
    if (isset($le_id)) {
        ...
        $sql_4 = "SELECT * FROM lease le, money mn 
                               WHERE mn.le_id = le.le_id  AND mn.mn_type =3 AND le.le_id = $le_id AND mn.mn_first_pay = 1
                               ORDER BY mn_id DESC";
        $result_4 = mysqli_query($conn, $sql_4);
        $row_4 = mysqli_fetch_assoc($result_4);
        //ถ้าเป็นสัญญา 2 และจ่ายรายปี หรือ สัญญา 3 แสดง ปี
        if (($row_4["type_pay"] == "year" and $row_4["le_type"] == "2")) {
            $tp = "ปี";
        } else {
            $tp = "เดือน";
        }
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <!-- Back -->
            <div>
                <a href="02_1_money.php" class="back" style="text-decoration:none;">
            ...
            <div class="title">
                สถานะการเงิน ประเภทสัญญาเช่าเพื่องานบริการ
            </div>
            <hr>
            ...
            <?php if ($count_m > 0) { ?>
                        ...
                        <tbody>
                            ...
                            <?php if ($row_1['mn_status'] != 100) { ?>
                                <tr>
                                    ...
                                    <td><a href="02_5_see_data_02_2_3.php?le_id=<?php echo $row_1["le_id"]; ?>"> <?php echo  $row_1['le_no']; ?> </a></td>
                        ...
                        <tbody>
                            ...
                            <?php if ($row_1['mn_status'] != 100) { ?>
                                <tr>
                                    ...
                                    <td><a href="02_5_see_data_02_2_3.php?le_id=<?php echo $row_2["le_id"]; ?>"> <?php echo  $row_2['le_no']; ?> </a></td>
                ...
                <!-- รายปี / รายเดือน-->
                <?php if ($row_2['le_duration'] > 1 and (($row_4["type_pay"] == "year" and $row_4["le_type"] == "2"))) { ?>
                            ...
                            <tbody>
                                <tr>
                                    <?php while ($row_3 = mysqli_fetch_assoc($result_3)) { ?>
                                        ...
                                        <td><a href="02_5_see_data_02_2_3.php?le_id=<?php echo $row_3["le_id"]; ?>"> <?php echo  $row_3['le_no']; ?> </a></td>
                ...
                <?php } else if (($row_4["type_pay"] == "month" and $row_4["le_type"] == "2")) { ?>
                    <!-- รายเดือน -->
                    <div class="title">
                        ค่าเช่าราย<?php $tp ?>
                    </div>
