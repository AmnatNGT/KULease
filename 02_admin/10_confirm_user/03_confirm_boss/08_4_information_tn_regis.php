<?php {
    ...
    // ดึงข้อมูลผู้ให้เช่า
    $sql = "SELECT * FROM lessor WHERE ls_id = $id ";  
...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper">
            ...
            <!-- Back -->
            <div>
                <a href="08_1_admin_check_tn_register.php" class="back" style="text-decoration:none;">
            ...
            <div class="form">
                ...
                <div class="inputfield">
                    ...
                    <input type="email" class="input" value="<?php echo date('d / m / Y ', strtotime($row["ls_date_regis"])); ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>บทบาท</label>
                    <input type="text" class="input" value="ผู้ให้เช่า" readonly>
                </div>

                <div class="inputfield">
                    <label>Email</label>
                    <input type="email" class="input" value="<?php echo $row['ls_email']; ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>คำนำหน้าชื่อ</label>
                    <input type="text" class="input" value="<?php echo $row['ls_p_name']; ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>ชื่อ</label>
                    <input type="text" class="input" value="<?php echo $row['ls_f_name'] ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>นามสกุล</label>
                    <input type="text" class="input" value="<?php echo $row['ls_l_name']; ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>ตำแหน่ง</label>
                    <?php if ($row['ls_role'] == null) {
                        $role = '----------';
                    } else {
                        $role = $row['ls_role'];
                    }
                ...
                <div class="inputfield">
                    ...
                    <input type="date" class="input" value="<?php echo $row['ls_birth_date']; ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>เบอร์โทรศัพท์</label>
                    <input type="tel" class="input" value="<?php echo $row['ls_tel']; ?>" readonly>
                </div>
