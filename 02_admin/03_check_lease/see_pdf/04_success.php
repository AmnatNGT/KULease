...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper_3">
            ...
            <!-- Back -->
            <div>
                <a href="../04_lease/01_lease.php" class="back" style="text-decoration:none;">
            ...
            <div class="form">
                ...
                <div class="inputfield">
                    ...
                    <input type="text" class="input" value="<?php echo $row_le["le_4_role"] ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>คณะ</label>
                    <input type="text" class="input" value="<?php echo $row_le["le_4_fact"] ?>" readonly>
                </div>
                ...
                <div class="inputfield">
                    ...
                    <input type="text" class="input" value="<?php echo $row_area["area_room_no"] ?>" readonly>
                </div>
            ...
            <div class="d-grid gap-2">
                <a href="04_pdf_db.php" target="_blank" class="btn btn-warning" onclick="return confirm('ยืนยัน : การตรวจสอบเอกสาร และแจ้งเตือนไปหาผู้เช่า')">ดูเอกสาร PDF File และ ส่งข้อความแจ้งเตือนผู้เช่าลงนาม</a>
            </div>
