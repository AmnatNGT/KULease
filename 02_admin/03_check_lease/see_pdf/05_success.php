...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper_3">
            ...
            <!-- Back -->
            <div>
                <a href="../05_lease/01_lease.php" class="back" style="text-decoration:none;">
            ...
            <div class="form">
                ...
                <div class="inputfield">
                    <label>ราคาเช่าคิดเป็นร้อยละ / ของยอดขายแต่ละเดือน (%)</label>
                ...
                <?php if ($row_mn_dp['mn_no_important'] == null) { ?>
                    <div class="inputfield">
            ...
            <div class="d-grid gap-2">
                <a href="05_pdf_db.php" target="_blank" class="btn btn-warning" onclick="return confirm('ยืนยัน : การตรวจสอบเอกสาร และแจ้งเตือนไปหาผู้เช่า')">ดูเอกสาร PDF File และ ส่งข้อความแจ้งเตือนผู้เช่าลงนาม</a>
            </div>
