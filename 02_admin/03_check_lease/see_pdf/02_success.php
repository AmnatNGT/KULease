...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper_3">
            ...
            <!-- Back -->
            <div>
                <a href="../02_lease/01_lease.php" class="back" style="text-decoration:none;">
            ...
            <div class="form">
                ...
                <div class="inputfield" id="tn_p_name_oth">
                    ...
                    <input type="text" class="input" value="ประเภทสัญญาเพื่องานบริการ" readonly>
                </div>
                ...
                <div class="inputfield">
                    ...
                    <input type="text" class="input" value="<?php echo $row_agc["agc_name"] ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>ที่อยู่หน่วยงาน</label>

                    <?php if ($row_agc["agc_house_no"] == null) {
                        $agc_no = '---';
                    } else {
                        $agc_no = $row_agc["agc_house_no"];
                    } ?>
                    <?php if ($row_agc["agc_road"] == null) {
                        $agc_road = '---';
                    } else {
                        $agc_road = $row_agc["agc_road"];
                    } ?>
                    <?php if ($row_agc["agc_canton"] == null) {
                        $agc_ct = '---';
                    } else {
                        $agc_ct = $row_agc["agc_canton"];
                    } ?>
                    <input type="text" class="input" readonly value="<?php echo "บ้านเลขที่ : " . $agc_no . " , ถนน : " . $agc_road .
                                                                            " , ตำบล/แขวง : " . $agc_ct . " , อำเภอ/เขต : " . $row_agc["agc_district"] .
                                                                            " , จังหวัด : " . $row_agc["agc_province"];
                                                                        ?>" readonly>
                ...
                <div class="inputfield">
                    <label>ขนาดพื้นที่ กว้าง X ยาว (ม.)</label>
                    <input type="text" class="input" value="<?php echo $row_area["area_width"] . " X " . $row_area["area_height"] ?>" readonly>
                </div>
                ...
                <div class="inputfield">
                    <?php if ($row_mn_month["type_pay"] == "month") {
                        $ans = "เดือน";
                    ...
                    <input type="text" class="input" value="<?php echo "ราย" . $ans ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>ราคาเช่า / <?php $ans ?> (บาท)</label>
                    <input type="text" class="input" value="<?php echo $row_mn_month["mn_cost"] ?>" readonly>
                </div>
                ...
                <!-- พยานของผู้เช่า -->
                <div class="inputfield">
                    <label>พยานของผู้เช่า</label>
                    <input type="text" class="input" value="<?php echo $row_wn_3["wn_p_name"] . " " . $row_wn_3["wn_f_name"] . " " . $row_wn_3["wn_l_name"] ?>" readonly>
                </div>

                <div class="inputfield">
                    <label>ตำแหน่ง พยานของผู้เช่า</label>

                    <?php
                    if ($row_wn_3["wn_role"] == null) {
                        $result_role_3 = '----------';
                    } else {
                        $result_role_3 = $row_wn_3["wn_role"];
                    }
                    ?>
                    <input type="text" class="input" value="<?php echo $result_role_3 ?>" readonly>
                </div>
            ...
            <!-- ถ้ากด  ดูเอกสาร PDF File และ ส่งข้อความแจ้งเตือนผู้เช่าลงนาม ไปที่หน้า 02_pdf_db.php แบบ target="_blank" -->
            <!-- เพื่อส่งข้อความแจ้งเตือนผู้เช่าว่าเพิ่มสัญญาเช่าแล้ว และ Set pdf file -->
            <div class="d-grid gap-2">
                <a href="02_pdf_db.php" target="_blank" class="btn btn-warning" onclick="return confirm('ยืนยัน : การตรวจสอบเอกสาร และแจ้งเตือนไปหาผู้เช่า')">ดูเอกสาร PDF File และ ส่งข้อความแจ้งเตือนผู้เช่าลงนาม</a>
            </div>
