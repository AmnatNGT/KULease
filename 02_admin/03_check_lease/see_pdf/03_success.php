...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper_3">
            ...
            <!-- Back -->
            <div>
                <a href="../03_lease/01_lease.php" class="back" style="text-decoration:none;">
            ...
            <div class="form">
                ...
                <div class="inputfield" id="tn_p_name_oth">
                    ...
                    <input type="text" class="input" value="ประเภทสัญญาเพื่องานวิจัย / การเรียนการสอน" readonly>
                </div>
            ...
            <div class="d-grid gap-2">
                <a href="03_pdf_db.php" target="_blank" class="btn btn-warning" onclick="return confirm('ยืนยัน : การตรวจสอบเอกสาร และแจ้งเตือนไปหาผู้เช่า')">ดูเอกสาร PDF File และ ส่งข้อความแจ้งเตือนผู้เช่าลงนาม</a>
            </div>
