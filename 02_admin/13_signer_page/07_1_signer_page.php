                                ...
                                <div class="wrapper_md">
                                    ...
                                    <div class="form">
                                        ...
                                        <div class="inputfield">
                                            <label>คำนำหน้าชื่อ <strong style="color: red;">*</strong></label>
                                        ...
                                        <div class="inputfield" id="tn_p_name_oth_2" style="display:none">
                                            <label>คำนำหน้าชื่อ อื่นๆ <strong style="color: red;">*</strong></label>
                                        ...
                                        <div class="inputfield">
                                            <label>บัตรประจำตัวประชาชน (รูปภาพ/PDF) <strong style="color: red;">*</strong></label>
                                            <input type="file" class="input" name="file_1" accept=".png, .jpg, .jpeg, .pdf" required>
                                        </div>
                                    </div>
                                    <br>
