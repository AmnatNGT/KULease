...
<?php
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <!-- แสดงข้อมูลผู้ลงนาม -->
            <div class="title">
                ผู้เช่า ตรวจสอบข้อมูลผู้ลงนามก่อนหน้า
            </div>
            <div class="form">
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
                <!-- ลงนาม ไปหน้า "02_sign.php-->
                <a href="02_sign.php?le_id=<?php echo $row['le_id'] ?>" class="btn btn-warning" type="button">ลงนาม</a>
                <!-- แนบรูปภาพลายเซ็น ไปหน้า  08_2_insert_sign_img.php-->
                <a href="08_2_insert_sign_img.php?le_id=<?php echo $row['le_id'] ?>" class="btn btn-primary" type="button">แนบรูปภาพลายเซ็น</a>
