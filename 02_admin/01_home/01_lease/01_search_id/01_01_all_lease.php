<?php {
    ...
    //รับเลขที่อ้างอิงที่ search มา
    $search_no = $_SESSION['search_no'];
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ประเภทสัญญาเช่าเพื่อร้านค้าหรือพาณิชย์
            </div>


            <div class="form">

                <!-- ค้นหา ไปหน้า 01_01_all_lease.php-->
                <form action="01_01_all_lease.php" method="POST">
