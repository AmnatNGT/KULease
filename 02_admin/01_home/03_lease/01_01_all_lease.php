<?php {
    ...
    $sql = "SELECT * FROM lease l, status_lease stl , area ar
                     WHERE l.le_type=3 AND l.le_id = stl.le_id AND l.area_id = ar.area_id 
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ประเภทสัญญาเช่าเพื่องานวิจัย / การเรียนการสอน
            </div>
            ...
            <div class="form">
                ...
                <!-- ค้นหา ไปหน้า 01_search_id/01_01_all_lease.php-->
