<?php {
    ...
    $sql = "SELECT * FROM area WHERE area_type = 5 AND area_status_show = 1 ORDER BY area_name ASC";
                    ...
                    <tbody>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <?php if ($row["area_status"] == '0') { ?>
                                    <td>
                                        <!-- กดแก้ไข ไปหน้า 05_5_4_area_edit.php ส่ง id พื้นที่ -->
                                        <a href="05_5_4_area_edit.php?idsub=<?php echo $row["area_id"] ?>" class="btn btn-warning">แก้ไข</a>
                                        <!-- กดลบ ไปหน้า 05_5_3_delete_area_db.php ส่ง id พื้นที่ -->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div>เพิ่มพื้นที่เช่า ประเภทสัญญาเพื่อโรงอาหาร</div>
