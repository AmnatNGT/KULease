<?php {
    ...
    //หาข้อมูลพื้นที่
    $sql_area = "SELECT * FROM area WHERE area_type = '1' AND area_status_show = 1 AND area_status = '0' ";
...
<body>
    ...
    <main class="data ">
        ...
        <div class="wrapper_3">
            ...
            <!-- เพิ่มข้อมูลและส่งไปหน้า 02_4_type_1_2_db.php แบบ POST -->
            <form action="02_4_type_1_2_db.php" method="POST" enctype="multipart/form-data">

                <!-- ส่ง id สัญญาเช่าไปด้วย -->
                <input name="le_id" type="hidden" value="<?php echo $id; ?>">
                ...
                <div class="form">
                    ...
                    <div class="inputfield">
                        ...
                        <select class="form-select" name="area_name" id="area_name" required autofocus>
                ...
                <button class="btn_pri" name="save" onclick="return confirm('ยืนยันการเพิ่ม')">บันทึกข้อมูลสัญญาเช่า</button>
                <br><br>
    ...
    <!--script-->
    <script>
        // ถ้าข้องมูลของพื้นที่ เกิดการเปลี่ยนแปลงจากบรรทัด 186 ให้ส่งค่า id พื้นที่มาที่นี่
        $('#area_name').change(function() {
            ...
            //เมื่อเสร็จแล้วส่งขนาดพื้นที่ ที่ตรงกับพื้นที่ที่เลือก กลับมาที่ตัวแปร data และแสดงผลที่ area_size บรรทัด 194
            $.ajax({
                type: "POST",
