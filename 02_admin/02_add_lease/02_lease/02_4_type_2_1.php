<?php {
    ...
    //หาข้อมูลพื้นที่
    $sql_area = "SELECT * FROM area WHERE area_type = '2' AND area_status_show = 1 AND area_status = '0' ";
...
<body>
        ...
        <div class="wrapper_3">
            ...
            <div class="form">
                ...
                <div class="inputfield" id="tn_p_name_oth">
                    ...
                    <input type="text" class="input" value="เพื่องานบริการ" readonly>
                </div>
            </div>
            <br>

            <!-- เพิ่มข้อมูลและส่งไปหน้า 02_4_type_2_2_db.php แบบ POST -->
            <form action="02_4_type_2_2_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form">
                    ...
                    <script type="text/javascript">
                        // ถ้าข้องมูลของจังหวัดเกิดการเปลี่ยนแปลงจากบรรทัด 206 ให้ส่งค่า id จังหวัดมาที่นี่
                        $('#provinces').change(function() {
                            ...
                            //เมื่อเสร็จแล้วส่งค่าอำเภอทั้งหมดที่อยู่ในจังหวัดที่เลือก กลับมาที่ตัวแปร data และแสดงผลที่ id amphures บรรทัด 215
                            $.ajax({
                                type: "POST",
                        ...
                        // ถ้าข้องมูลของอำเภอเกิดการเปลี่ยนแปลงจากบรรทัด 216 ให้ส่งค่า id อำเภอมาที่นี่
                        $('#amphures').change(function() {
                            ...
                            //เมื่อเสร็จแล้วส่งค่าตำบลทั้งหมดที่อยู่ในอำเภอที่เลือก กลับมาที่ตัวแปร data และแสดงผลที่ id districts บรรทัด 225
                            $.ajax({
                                type: "POST",
                                url: "../find/find_provinces_db.php",
                                data: {
                    ...
                    <div class="inputfield">
                        <label>กว้าง X ยาว (เมตร)</label>
                        <input type="text" class="input" name="wh" id="wh" placeholder="กว้าง X ยาว" readonly>
                    </div>
                    ...
                    <div class="inputfield">
                        <label>การชำระเงิน รายเดือน / ปี <strong>*</strong></label>
                        <select class="form-select" name="type_pay" id="type_pay" onchange="type_lease()" required>
                            <option selected hidden value="">เลือกประเภทการชำระเงิน รายเดือน / ปี</option>
                            <option value="month">ชำระรายเดือน</option>
                            <option value="year">ชำระรายปี</option>
                        </select>
                    </div>

                    <div class="inputfield">
                        <label>ราคาเช่า <strong>*</strong></label>
                        <input type="number" class="input" name="le_2_mn" id="" placeholder="ราคาเช่า" required>
                    </div>
                    ...
                    <div class="inputfield">
                        <label>พยานฝั่งผู้เช่า <strong>*</strong></label>
                        <select class="form-select" name="wn_1" id="wn_1" required>
                            <option selected readonly hidden value="">เลือกพยาน</option>
    ...
    <!--script-->
    <script>
        // ถ้าข้องมูลของพื้นที่เกิดการเปลี่ยนแปลงจากบรรทัด 294 ให้ส่งค่า id พื้นที่มาที่นี่
        $('#area_name').change(function() {
            ...
            //เมื่อเสร็จแล้วส่งขนาดพื้นที่ ที่ตรงกับพื้นที่ที่เลือก กลับมาที่ตัวแปร data และแสดงผลที่ area_size บรรทัด 302
            $.ajax({
                type: "POST",
        ...
        $('#area_name').change(function() {
            ...
            //เมื่อเสร็จแล้วส่งความ กว้าง x ยาว ที่ตรงกับพื้นที่ที่เลือก กลับมาที่ตัวแปร data และแสดงผลที่ wh บรรทัด 307
            $.ajax({
                type: "POST",
                url: "../find/find_ajex_db.php",
                data: {
        ...
        // ถ้าข้องมูลของพยานเกิดการเปลี่ยนแปลงจากบรรทัด 349 ให้ส่งค่า id พื้นที่มาที่นี่
        $('#wn_1').change(function() {
            ...
            //เมื่อเสร็จแล้วส่งความตำแหน่งพยาน ที่ตรงกับพยานที่เลือก กลับมาที่ตัวแปร data และแสดงผลที่ wn_role_1 บรรทัด 364
            $.ajax({
                type: "POST",
                url: "../find/find_ajex_db.php",
                data: {
