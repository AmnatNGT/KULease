<?php {
    ...
    // วิเคราะห์รายรับ { รายปีงบประมาณ } ทุกประเภทสัญญา

    //ดึงข้อมูล
    // mn_cost บวกกัน
    // ที่ประเภทการจ่ายเงิน 2 หรือ 3 และ ที่ mn_status = 1
    // และ GROUP BY m.mn_budget_year
    $sql = "SELECT m.mn_cost, SUM(m.mn_cost) AS total, m.mn_budget_year AS budget_year, count(l.le_id) AS count_le
        FROM money m , lease l 
        WHERE l.le_status!=3 AND l.le_id = m.le_id AND m.mn_status = 1 AND (m.mn_type = 3 or m.mn_type = 2)
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <!-- กราฟ -->
            <div class="title">
                วิเคราะห์รายรับ { รายปีงบประมาณ } ทุกประเภทสัญญาเช่า
            </div>
            <div class="form">
            ...
            <div class="title">
                ตารางข้อมูลสัญญาเช่า { รายปีงบประมาณ } ทุกประเภทสัญญาเช่า
            </div>
