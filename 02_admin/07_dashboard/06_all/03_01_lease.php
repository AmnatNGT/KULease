<?php {
    ...
    // วิเคราะห์รายรับ { รายวัน } ทุกประเภทสัญญา
    ...
    $sql = "SELECT m.mn_cost, 
                   ...
                   WHERE l.le_id = m.le_id AND l.le_status!=3
                   AND m.mn_status = 1 
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                วิเคราะห์รายรับ { รายวัน } ทุกประเภทสัญญาเช่า
            </div>
            ...
            <div class="form">
                ...
                <div class="title">
                    ตารางข้อมูลสัญญาเช่า { รายวัน } ทุกประเภทสัญญาเช่า
                </div>
