<?php {
    ...
    // วิเคราะห์รายรับ { รายปีงบประมาณ } ประเภทสัญญา 4
    ...
    $sql = "SELECT m.mn_cost, SUM(m.mn_cost) AS total, m.mn_budget_year AS budget_year ,count(l.le_id) as c_le
        ...
        WHERE l.le_type = 4 AND l.le_status!=3 AND l.le_id = m.le_id AND m.mn_status = 1 AND (m.mn_type = 3 or m.mn_type = 2)
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <!-- กราฟ -->
            <div class="title">
                วิเคราะห์รายรับ { รายปีงบประมาณ } ประเภทสัญญาเพื่อที่พักอาศัย
            </div>
            <div class="form">
            ...
            <div class="title">
                ตารางข้อมูลสัญญาเช่า { รายปีงบประมาณ } ประเภทสัญญาเพื่อที่พักอาศัย
            </div>
