<?php {
    ...
    $sql = "SELECT * FROM lease le, status_lease stl, tenant t
            WHERE le.le_type = 3
                ...
                AND stl.st_boss = 1 AND stl.st_add_no = 0";
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            <div class="title">
                สัญญาเช่าที่ต้องเพิ่มเลขที่สัญญาเช่า / อากรแสตมป์ ประเภทสัญญาเพื่องานวิจัย/การเรียนการสอน
            </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                    ...
                                    <td><a href="05_see_lease.php?le_id=<?php echo $row["le_id"]; ?>"> <?php echo  $row['le_no']; ?> </a></td>
                                    ...
                                    <!-- เพิ่มเลขที่ สัญญา ไปหน้า 02_add_number.php ส่ง id สัญญา-->
                                    <td><a href="02_add_number.php?le_id=<?php echo $row['le_id']; ?>" class="btn btn-danger" onclick="return confirm('ต้องการ : เพิ่มเลขที่สัญญาเช่า / อากรแสตมป์')">เพิ่มเลขที่สัญญาเช่า / อากรแสตมป์</a></td>
