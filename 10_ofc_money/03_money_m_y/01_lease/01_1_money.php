<?php {
    ...
    // แสดงข้อมูลการเงินประเภทที่ 1
    $sql = "SELECT * FROM lease le, money mn 
                WHERE le.le_type = 1 AND mn.le_id = le.le_id AND mn.mn_type =3 AND mn.mn_first_pay = 1";
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="form">
                ...
                <!-- ค้นหาด้วยเลขที่อ้างอิงสัญญา ไปหน้า 01_4_search_1.php-->
