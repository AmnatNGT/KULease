...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                สถานะการเงิน ประเภทสัญญาเพื่องานบริการ
            </div>
            <hr>
            ...
            <?php if ($count_11 > 0) { ?>
                                ...
                                <tr>
                                    <?php while ($row_3 = mysqli_fetch_assoc($result_3)) { ?>
                                        ...
                                        <form action="01_3_pay_money_db.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input name="type_pay" type="hidden" value="<?php echo $row_3["type_pay"]; ?>">
                                            <input name="tn_tel" type="hidden" value="<?php echo $row_ch["tn_tel"]; ?>">
                ...
                // <!-- รายเดือน -->
                else if (($row_4["type_pay"] == "month" and $row_4["le_type"] == "2")) { ?>
                    <!-- รายเดือน -->
                    <div class="title">
                        ค่าเช่าราย<?php echo $tp ?>
                    </div>
                                ...
                                <tr>
                                    <?php while ($row_3 = mysqli_fetch_assoc($result_3)) { ?>
                                        ...
                                        // แนบหลักฐานการชำระ เข้า if นี้ 
                                            ...
                                            <!-- เมือกดให้เรียก modal #showForm2-->
                                            <td><a class="btn_b" data-bs-target="#showForm2" data-bs-toggle="modal">แนบหลักฐาน</a></td>
