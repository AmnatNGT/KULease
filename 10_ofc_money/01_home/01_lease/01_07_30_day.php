...
<?php
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ประเภทสัญญาเช่าเพื่อร้านค้าหรือพาณิชย์ ที่หมดอายุสัญญาเช่าภายใน 30 วัน
            </div>
                ...
                <div class="form">
                    ...
                    <table id="customers">
                        ...
                        <tbody>
                            ...
                            ?>
                                <!-- หาสัญญาเช่าประเภทที่ 1 ที่หมดอายุภายใน 30 วัน และแสดง -->
                                <?php if ($diff->format("%R%a") <= 30 and $diff->format("%R%a") >= 0) { ?>
                                   ...
                                   <td><?php echo $row['le_no']; ?></td>
                                    ...
                                    <td><?php echo $row['le_no_success'] ?>
                                     ...
                                     <!-- ว/ด/ป สิ้นสุดสัญญา --><td><?php echo date('d / m / y ', strtotime($row['le_end_date'])); ?></td>
                                    <!-- ระยะเวลาการเช่า -->
