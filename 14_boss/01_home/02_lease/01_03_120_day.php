<?php {
    ...
    //สัญญาเช่า ประเภท 2
    $sql = "SELECT * FROM lease WHERE le_type=2 AND le_status=1";
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <div class="title">
                ประเภทสัญญาเช่าเพื่อเพื่องานบริการ ที่หมดอายุสัญญาเช่าภายใน 120 วัน
            </div>
            ...
            <div class="form">
                ...
                <table id="customers">
                    ...
                    <tbody>
                        <!-- สัญญาเพื่อร้านค้าหรือพาณิชย์ 2-->
                        <?php while ($row = mysqli_fetch_assoc($result)) {
                            $ch_end_1_120 = date_create($row['le_end_date']);
                            $diff = date_diff($today, $ch_end_1_120);
                        ?>
                            <!-- หาสัญญาเช่าประเภทที่ 2 ที่หมดอายุภายใน 120 วัน และแสดง -->
                            <?php if ($diff->format("%a") <= 120 and $diff->format("%a") > 60) { ?>
