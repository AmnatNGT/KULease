...
$html = "<p style='color:red; position:absolute; top:675; left:485;'><img src='../../../../file_uploads/doc_signs/$pic'  width='190' height='45'></p>";
...
//แจ้งเตือนเจ้าหน้าที่เพิ่มสัญญา เจ้าหน้าที่พิเศษ
{
    ...
    while ($r1 = mysqli_fetch_assoc($result1)) { // วนลูปเจ้าหน้าที่ทุกคน
        ...
        $detail = "สัญญาเพื่องานวิจัย/การเรียนการสอน เลขที่สัญญาเช่า $le_no คณะนี้ผู้มีส่วนเกี่ยวข้องลงนามครบแล้ว ต่อไปอยู่ในสถานะเพิ่มเลขที่สัญญา โปรดตรวจสอบ";
