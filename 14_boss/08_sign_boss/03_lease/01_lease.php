<?php {
    ...
    //หาข้อมูลสัญญา
    //ที่ ประเภทสัญญ=3 และ สถานะสัญญา=1
    ...
    $sql = "SELECT * FROM lease le, status_lease stl, tenant t
            WHERE le.le_type = 3
                ...
                AND ( stl.st_s3= 1 AND stl.st_boss = 0 )";
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            <div class="title">
                ผู้ให้เช่า ลงนามสัญญาเช่า ประเภทสัญญาเพื่องานวิจัย/การเรียนการสอน
            </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                    ...
                                    <?php } else { ?>
                                        <td><a href="06_chk_data.php?le_id=<?php echo $row['le_id']; ?>" class="btn btn-success">ลงนาม</a></td>
                                    <?php } ?>
