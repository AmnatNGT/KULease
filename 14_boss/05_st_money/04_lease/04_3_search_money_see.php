<?php {
    ...
    $sql_le = "SELECT * FROM lease WHERE le_no = $le_no AND le_type = 4 ";
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            ...
            <!-- Back -->
            <div>
                <a href="04_1_money.php" class="back" style="text-decoration:none;">
                        ...
                        <tbody>
                            ...
                            <?php if ($row_1['mn_status'] != 100) { ?>
                                <tr>
                                    ...
                                    <td><a href="04_5_see_data_04_2_3.php?le_id=<?php echo $row_1["le_id"]; ?>"> <?php echo  $row_1['le_no']; ?> </a></td>
                        ...
                        <tbody>
                            ...
                            <?php if ($row_2['mn_status'] != 100) { ?>
                                <tr>
                                    ...
                                    <td><a href="04_5_see_data_04_2_3.php?le_id=<?php echo $row_2["le_id"]; ?>"> <?php echo  $row_2['le_no']; ?> </a></td>
                        ...
                        <tbody>
                            <tr>
                                <?php while ($row_3 = mysqli_fetch_assoc($result_3)) { ?>
                                    ...
                                    <td><a href="04_5_see_data_04_2_3.php?le_id=<?php echo $row_3["le_id"]; ?>"> <?php echo  $row_3['le_no']; ?> </a></td>
