...
// เลขทีอ้างอิงสัญญา
$le_no = $row_do['le_no'];
// ชื่อรูปลายเซนของเผู้จัดการหอ
$pic = $row_do['ofc1_sign_pic'];

// $html = "<p style='color:red; position:absolute; top:653; left:115;'><img src='../../../../file_uploads/doc_signs/$pic'  width='190' height='45' ></p>";

// จัดตำแหน่งที่จะวางลายเซน
$html = "<p style='color:red; position:absolute; top:829; left:125;'><img src='../../../../file_uploads/doc_signs/$pic'  width='190' height='45'></p>";
