<?php {
    ...
    //หาข้อมูลสัญญา
    //ที่ ประเภทสัญญ=4 และ สถานะสัญญา=1
    ...
    $sql = "SELECT * FROM lease le, status_lease stl, tenant t
            WHERE le.le_type = 4
                ...
                AND ( stl.st_s1= 1 AND stl.st_s2 = 0 )";
...
<body>
    ...
    <main class="data ">
        <div class="wrapper_2">
            <div class="title">
                ผู้จัดการหอพัก ลงนามสัญญาเช่า ประเภทสัญญาเพื่อที่พักอาศัย
            </div>
                ...
                <table id="customers">
                    <thead>
                        <tr>
                            ...
                            <th id="">ผู้จัดการหอพักตรวจสอบข้อมูล <br> ลงนาม</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                ...
                                <!-- ลงนาม -->
                                <?php if ($row['st_mn_pay'] != 1) { ?>
                                    <td><a href="#" class="btn btn-secondary">ตรวจสอบข้อมูล และลงนาม</a></td>
                                <?php } else { ?>
                                    <td><a href="06_chk_data.php?le_id=<?php echo $row['le_id']; ?>" class="btn btn-success">ตรวจสอบข้อมูล และลงนาม</a></td>
                                <?php } ?>
