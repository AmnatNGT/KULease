<?php {
    ...
    // ดึงข้อมูลทั้งหมดจากตาราง lease, status_lease ที่ tn_id = id
    // ดึงข้อมูลทั้งหมดที่เป็นของผู้เช่าคนที่เข้าสู่ระบบ และเรียงจากน้อยไปมาก เพื่อแสดงอันแรก
    ...
    if (mysqli_num_rows($result_do) >= 1) {
        ...
        //เอาเลขที่อ้างอิงสัญญาเช่ามา
        $search_id = $row_do['le_no'];
    ...
    <main class="data ">
        ...
        <div class="wrapper">
            ...
            <div class="form">
                ...
                <!-- ดูเอกสารสัญญาเช่า-->
                <!-- ถ้ายังไม่ส่งเรื่องทำสัญญาเช่าจะไม่แสดงอันนี้ -->
                <?php if ($row['tn_count_use'] != 0) { ?>
